...
st.set_page_config(layout="wide", page_title="3D Fat Suppression v2")

# Set the title of the Streamlit app
st.title("🧠 3D Fat Suppression DICOM Volume Viewer v2")
    ...
    if GENERATOR_3D is None:
        if FRAMEWORK == 'tensorflow':
            ...
            try:
                ...
                st.sidebar.write('<h4 style="color:green;">✅ Pre-trained TensorFlow weights loaded!</h4>', unsafe_allow_html=True)
            except:
...
st.sidebar.markdown("""
Upload multiple DICOM slices to form a 3D volume and apply advanced 3D fat suppression using our enhanced U-Net architecture.
...
# Footer
st.markdown("---")
st.markdown("*Developed by Pixellence - Advanced 3D Medical Image Processing*")
